          ...
          <div data-custom-class="body">
                ...
                <strong>
                  <span style={{ fontSize: 15 }}>
                    <span data-custom-class="subtitle">
                      Last updated <bdt className="question">May 28, 2022</bdt>
                    </span>
                  </span>
                </strong>
              </span>
              ...
              <span style={{ color: "rgb(127, 127, 127)" }}>
                <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
                  <span data-custom-class="body_text">
                    ...
                    <bdt className="question">Code to image Generator</bdt>
              ...
              <span style={{ color: "rgb(127, 127, 127)" }}>
                <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
                  <span data-custom-class="body_text">
                    ...
                    <bdt className="question">Code to image Generator</bdt>) are
              ...
              <span style={{ color: "rgb(127, 127, 127)" }}>
                <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
                  <span data-custom-class="body_text">
                    ...
                    <bdt className="statement-end-if-in-editor" /> party cookies
                ...
                <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
                  ...
                  <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                    <span data-custom-class="body_text">
                      ...
                      has visited our Websites
                      <bdt className="block-component" /> or opened an e-mail
                      including them
                ...
                <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                  <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                    <span data-custom-class="body_text">
                      ...
                      <bdt className="question">rohidul209@gmail.com</bdt> or by
                      post to:
                    </span>
                  </span>
                </span>
            ...
            <div style={{ lineHeight: "1.5" }}>
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <bdt className="question">
                  <span data-custom-class="body_text">
                    Road 9, Block H, bashundhara residential area, Bangladesh
                  </span>
                </bdt>
                <span data-custom-class="body_text">
                  <bdt className="block-component" />
            ...
            <div style={{ lineHeight: "1.5" }}>
              <span data-custom-class="body_text">
                <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                  <bdt className="question">Dhaka</bdt>
                  <bdt className="block-component" />,{" "}
                  <bdt className="question">State</bdt>
                  <bdt className="statement-end-if-in-editor" />
                  <bdt className="block-component" />{" "}
                  <bdt className="question">1229</bdt>
                  <bdt className="statement-end-if-in-editor" />
                  <bdt className="block-component" />
                  <bdt className="block-component" />
                </span>
            ...
            <div style={{ lineHeight: "1.5" }}>
              <span data-custom-class="body_text">
                <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                  <bdt className="question">Bangladesh</bdt>
                  <bdt className="statement-end-if-in-editor" />
                </span>
              </span>
              <span data-custom-class="body_text">
            ...
            <div style={{ lineHeight: "1.5" }}>
              <span data-custom-class="body_text">
                <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                  Phone: <bdt className="question">01745867428</bdt>
                  <bdt className="block-component" />
                </span>
              </span>
            </div>
